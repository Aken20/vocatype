...
WhisperType is a fully-local Windows voice dictation app inspired by [Voquill](https://github.com/voquill/voquill). Press `Ctrl+Alt+D`, speak naturally, and your words appear in any text field — cleaned up by a local AI.
...
```
Ctrl+Alt+D → WASAPI mic → faster-whisper (small) → Llama-3.2-3B → clipboard paste
